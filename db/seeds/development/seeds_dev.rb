...
doc1_video = open("https://docuflix-seeds-pro.s3.amazonaws.com/videos/#{name1}-trailer-1_a720p.m4v")
doc1_thumb = open("https://docuflix-seeds-pro.s3.amazonaws.com/thumbnails/#{name1}_background_2x.jpeg")
...
doc2_video = open("https://docuflix-seeds-pro.s3.amazonaws.com/videos/#{name2}-trailer-1_a720p.m4v")
doc2_thumb = open("https://docuflix-seeds-pro.s3.amazonaws.com/thumbnails/#{name2}_background_2x.jpeg")
...
doc3_video = open("https://docuflix-seeds-pro.s3.amazonaws.com/videos/#{name3}-trailer-1_a720p.m4v")
doc3_thumb = open("https://docuflix-seeds-pro.s3.amazonaws.com/thumbnails/#{name3}_background_2x.jpeg")
...
doc4_video = open("https://docuflix-seeds-pro.s3.amazonaws.com/videos/#{name4}-trailer-1_a720p.m4v")
doc4_thumb = open("https://docuflix-seeds-pro.s3.amazonaws.com/thumbnails/#{name4}_background_2x.jpeg")
...
doc5_video = open("https://docuflix-seeds-pro.s3.amazonaws.com/videos/#{name5}-trailer-1_a720p.m4v")
doc5_thumb = open("https://docuflix-seeds-pro.s3.amazonaws.com/thumbnails/#{name5}_background_2x.jpeg")
